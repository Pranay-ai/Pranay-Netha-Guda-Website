            ...
            {isMobile ? (
                <div className="mobileprojectList">
                    {data.map((project, index) => (
                        <div className="mobileProject" key={index}>
                            <div className="projectItem" onClick={() => handleProjectClick(index)}>
                ...
                <div className="ProjectSection">
                    ...
                    <div className="projectList">
                        {data.map((project, index) => (
                            <div className="projectItem" key={index} onClick={() => handleProjectClick(index)}>
                                <img src={project.imgSrc} alt={project.title} />
                                <h1>{project.title}</h1>
                            </div>
                        ))}
